...
const DiscriptionBox = () => {
  ...
  <div className="descriptionbox-description">
      <p>An e-commerce website is an online platform that facilitates the buying and selling of products or services over the internet. It serves as a virtual marketplace where businesses and individuals can showcase these products, interact customers, and conduct transactions without the need for a physical presence. E-commerce websites have gained immanse popularity due to their convenience, accessibility, and the global reach they offer.  </p>
